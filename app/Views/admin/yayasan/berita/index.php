...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    ...
    <a href="<?= base_url('admin/yayasan/berita/create') ?>"
            ...
            <tbody>
                ...
                <?php foreach ($berita as $i => $row): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('admin/yayasan/berita/edit/' . $row['id']) ?>"
                                class="btn btn-sm btn-warning me-1">
                                <i class="typcn typcn-edit"></i>
                            </a>

                            <a href="<?= base_url('admin/yayasan/berita/toggle/' . $row['id']) ?>"
                                class="btn btn-sm btn-info me-1">
                                <i class="typcn typcn-refresh"></i>
                                <?= $row['status'] === 'publish' ? 'Draft' : 'Publish' ?>
                            </a>

                            <a href="<?= base_url('admin/yayasan/berita/delete/' . $row['id']) ?>"
            ...
            <div class="card-body">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="<?= base_url('admin/yayasan/berita/toggle/' . $row['id']) ?>"
                        ...
                        <?= $row['status'] === 'publish' ? 'Jadikan Draft' : 'Publish' ?>
                    </a>
