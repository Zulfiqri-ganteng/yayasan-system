...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <form action="<?= base_url('sekolah/jurusan/update/' . $jurusan['id']) ?>"
            method="post"
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi"
                    rows="4"
                    class="form-control"><?= old('deskripsi', $jurusan['deskripsi']) ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number"
                    name="urutan"
                    value="<?= old('urutan', $jurusan['urutan']) ?>"
                    class="form-control">
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-select">
                    <option value="draft" <?= old('status', $jurusan['status']) === 'draft' ? 'selected' : '' ?>>Draft</option>
                    <option value="publish" <?= old('status', $jurusan['status']) === 'publish' ? 'selected' : '' ?>>Publish</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if (!empty($jurusan['foto_cover'])): ?>
                    <div class="mb-2">
                        <img src="<?= base_url('uploads/sekolah/jurusan/' . $jurusan['foto_cover']) ?>"
