...
<head>
    ...
    <title><?= lang('App.reset_password') ?> | <?= lang('App.system_name') ?></title>
...
<body>
    ...
    <div class="wrapper">
        <div class="card-reset">
            ...
            <div class="brand">
                ...
                <h1 class="brand-title"><?= lang('App.create_new_password') ?></h1>
                <p class="brand-subtitle"><?= lang('App.password_strength_notice') ?></p>
            </div>
            ...
            <form method="post" action="<?= base_url('reset-password') ?>" id="resetForm">
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password"
                            ...
                            placeholder="<?= lang('App.min_characters') ?>"
                            required>
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password"
                            ...
                            id="password_confirm"
                            class="form-control-custom"
                            placeholder="<?= lang('App.repeat_new_password') ?>"
                            required>
                    </div>
                </div>
                ...
                <button type="submit" id="resetBtn" class="btn-reset">
                    ...
                    <span><?= lang('App.reset_password_button') ?></span>
                </button>
    ...
    <!-- SCRIPT INTERAKSI FORM (TOGGLE PASSWORD, PROGRESS BERTAHAP) -->
    <script>
        (function() {
            ...
            resetForm.addEventListener('submit', function(e) {
                ...
                progressText.innerHTML =
                    '<i class="fas fa-search"></i> <span><?= lang('App.validating_data') ?></span>';

                setTimeout(() => {

                    progressBar.style.width = '70%';
                    progressText.innerHTML =
                        '<i class="fas fa-lock"></i> <span><?= lang('App.updating_password') ?></span>';

                    setTimeout(() => {

                        progressBar.style.width = '100%';
                        progressText.innerHTML =
                            '<i class="fas fa-check-circle"></i> <span><?= lang('App.password_updated_redirect') ?></span>';
